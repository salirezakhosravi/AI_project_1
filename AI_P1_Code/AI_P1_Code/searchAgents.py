        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if(hitsWall == 0):
                ...
                if next_position in self.corners:
                    index = self.corners.index(next_position)
                    visited_corners[index] = True
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    for index, visited_corner in enumerate(visited_corners):
        if visited_corner == False:
            unvisited_corners.append(problem.corners[index])
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    heuristic = max(mazeDistance(position, food_position, problem.startingGameState) for food_position in food_coordinates)
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        closestPath_toClosestDot = search.bfs(problem)

        return closestPath_toClosestDot
